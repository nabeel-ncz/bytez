...
import { createProduct } from '../../../store/actions/admin/adminActions';
                ...
                >
                    <Form className="">
                        <div className="flex w-full justify-end gap-4">
                            <button
                                className="flex items-center gap-2 p-2 rounded-lg bg-gray-200 text-blue-gray-800"
                            >
                                Cancel
                            </button>
                            <button type='submit'
                                className="flex items-center gap-2 p-2 rounded-lg bg-blue-gray-800 text-white"
                            >
                                Save
                            </button>
                        </div>
                            ...
                            <div className="lg:w-2/6">
                                ...
                                <div className="bg-white p-5 rounded-lg mb-5 text-start">
                                    ...
                                    <Field
                                        ...
                                        className="w-full bg-blue-gray-50 rounded-md mt-2 py-2 px-3 text-sm outline-none border border-gray-200"
                                    >
                                        <option value="basicphones" >Basic Phones</option>
